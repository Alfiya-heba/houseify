  ...
  return (
    <div className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Projects'>
        ...
        <div className='overflow-hidden'>
            ...
            // style={{transform:`translateX(-${(currentIndex*100)/cardsToS
            // style={{ transform: `translateX(-${currentIndex * (100 / projectsData.length)}%)` }}
            // style={{ transform: `translateX(-${currentIndex * (100 / (projectsData.length / cardsToShow))}%)` }}
            style={{
                transform: `translateX(-${currentIndex * (cardsToShow === 1 ? 100 : 25)}%)`
              }}
